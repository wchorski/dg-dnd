...
- [Cure Wounds - Spells - D&D Beyond (dndbeyond.com)](https://www.dndbeyond.com/spells/cure-wounds)
### lv2 
- **Fighting Style** -> Blessed Warrior (2 cleric cantrips) Spellcasting 
- **Divine Smite** -> `2d8` (+1d8 for level 2 slot) [current = ]
cleric spell list 
- **Word of Radiance** - `5ft`, radiant damage AOE 
	- lv 1 `1d6`
	- lv 5 `2d6`
	- lv 11 `3d6`
	- lv 17 `4d6`
...
- **Channel Divinity: Vow of Enmity** - bonus action single enemy 10 ft. gain adv for 1min BANE - 1min Up to three creatures 40ft. charisma saving throws. fails = roll `1d4` subtract # 
...
###  Lv5 
 ...
 5. [Destructive Wave](http://dnd5e.wikidot.com/spell:destructive-wave)- Each creature you choose within **30 feet** of you must succeed on a *Constitution* saving throw or take **5d6** *thunder* damage, as well as **5d6** *radiant* or *necrotic* damage (your choice), and be *knocked prone*. A creature that succeeds on its saving throw takes *half damage* and isn’t knocked prone.

**_Spell Lists._** [Paladin](http://dnd5e.wikidot.com/spells:paladin)

### lv 6
- **Aura of Protection** - *layer of protection* around the player that **protects** the **player character** and other *allied creatures within 10 feet*
	- +2 Deflection Bonus
	- +2 To All Saving Throws
	- Immunity To All Mind-affecting Spells And Spell-like Abilities

### lv 7
- Oath Feature **Relentless Avenger** - your supernatural focus helps you close off a foe's retreat. When you hit a creature with an opportunity attack, you can **move up to half your speed immediately after the attack** and as part of the same reaction. This movement doesn't provoke opportunity attacks.
